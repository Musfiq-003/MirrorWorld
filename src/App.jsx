                ...
                <div className="app-header-left">
                    ...
                    <div className="app-control-strip">
                        <button
                            ...
                            style={{
                                border: view3D ? '1px solid rgba(0, 243, 255, 0.4)' : '1px solid rgba(255, 255, 255, 0.1)',
                                background: view3D ? 'rgba(0, 243, 255, 0.15)' : 'transparent',
                                boxShadow: view3D ? '0 0 15px rgba(0, 243, 255, 0.2)' : 'none',
                                color: view3D ? 'var(--accent-primary)' : 'var(--text-main)'
                            }}
                        >
